...
const runCypress = () => {
  ...
  currentTestProcess.on('close', (code) => {
    ...
    const mergeCommand = 'npx mochawesome-merge results/mochawesome*.json > results/mochawesome_final.json && npx marge results/mochawesome_final.json --reportDir results --reportFilename mochawesome-final';
